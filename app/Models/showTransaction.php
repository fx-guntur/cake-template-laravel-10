...
class showTransaction extends Model
{
    use HasFactory;
    use SoftDeletes;
    ...
    protected $fillable = [
        'uuid', 'merchant_id', 'customer_id', 'payment_id', 'payment_code',
        'invoice', 'type', 'amount', 'unique_code', 'charge',
        'transaction_date', 'transaction_paid_date', 'transaction_deadline',
