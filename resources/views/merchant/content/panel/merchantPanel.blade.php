                    ...
                    <table class="table table-centered table-nowrap mb-0 rounded mt-3">
                        <thead class="thead-light">
                            <tr>
                                ...
                                <th class="border-0">Nama Buah</th>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="/add-catalog">
                                    <img src="https://img.icons8.com/plumpy/26/000000/edit-calendar.png" />
                                </a>
                                |
                                <a href="/delete-catalog" onclick="myFunction()">
                                    <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="25" height="25"
                                        viewBox="0 0 172 172" style=" fill:#7d1710;">
